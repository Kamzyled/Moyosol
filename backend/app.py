...
# Load questions from questions.js equivalent
# We'll serve them as JSON for frontend to consume
...
def shuffle_questions(q_list, num):
    shuffled = random.sample(q_list, num)
    return shuffled
...
def join_game():
    ...
    return jsonify({"message": f"{player2_name} joined the game", "questions": games[game_code]["questions"]})
